//
//  ModifiedAlphaModel.swift
//  BalticBoxModel
//
//  Created by Bo Gustafsson on 2019-05-29.
...
class ModifiedAlphaModel : ModelSpecs {
    fileprivate let defaultParams = [
        ...
        Parameter(key: "o2min", name: "O2 full anoxia", value: 0.1, minValue: 0.0, maxValue: 1.0, explanation: "Oxygen threshold for full expansion of hypoxia", sensitivityCalculation: true),
        Parameter(key: "o2max", name: "O2 no anoxia", value: 0.1, minValue: 0.0, maxValue: 1.0, explanation: "Oxygen threshold for no hypoxia", sensitivityCalculation: true),
    ...
    fileprivate let defaultDimensions = [
        ...
        Parameter(key: "IPMAX1", name: "Max FeP conc. shallow (mmol/m2)", value: 100.0, minValue: 10.0, maxValue: 150.0, explanation: "Max FeP conc. (mmol/m2)", sensitivityCalculation: true),
        Parameter(key: "IPMAX2", name: "Max FeP conc. deep (mmol/m2)", value: 100.0, minValue: 10.0, maxValue: 150.0, explanation: "Max FeP conc. (mmol/m2)", sensitivityCalculation: true),
        Parameter(key: "O2In", name: "O2 in (uM)", value: 300.0, minValue: 100.0, maxValue: 300.0, explanation: "O2 in inflowing water", sensitivityCalculation: true),
        ...
        Parameter(key: "K1", name: "Piston velocity (m/yr) shallow", value: 20.0, minValue: 5.0, maxValue: 40.0, explanation: "Piston velocity for sediment-water exchange of O2 shallow", sensitivityCalculation: true),
        Parameter(key: "K2", name: "Piston velocity (m/yr) deep", value: 20.0, minValue: 5.0, maxValue: 40.0, explanation: "Piston velocity for sediment-water exchange of O2 deep", sensitivityCalculation: true),
        ...
        Parameter(key: "betaPlus", name: "𝜷 (O2 > 0)", value: 1.0, minValue: 0.1, maxValue: 4.0, explanation: "Redox depent preferential P regeneration", sensitivityCalculation: true),
        Parameter(key: "betaMinus", name: "𝜷 (O2 < 0)", value: 4.0, minValue: 1.0, maxValue: 8.0, explanation: "Redox depent preferential P regeneration", sensitivityCalculation: true),
        Parameter(key: "O2Min", name: "O2 full anoxia", value: 100.0, minValue: 0.0, maxValue: 100.0, explanation: "Oxygen threshold for full expansion of hypoxia", sensitivityCalculation: true),
        Parameter(key: "O2Max", name: "O2 no anoxia", value: 223.0, minValue: 100.0, maxValue: 300.0, explanation: "Oxygen threshold for no hypoxia", sensitivityCalculation: true),
        Parameter(key: "BUR1", name: "Burial rate (upper layer) (1/yr)", value: 0.005, minValue: 0.002, maxValue: 0.1, explanation: "Burial rate of organic matter", sensitivityCalculation: true),
        Parameter(key: "BUR2", name: "Burial rate (lower layer) (1/yr)", value: 0.005, minValue: 0.002, maxValue: 0.1, explanation: "Burial rate of organic matter", sensitivityCalculation: true),
        Parameter(key: "BURFE", name: "Burial rate of FeP (1/yr)", value: 0.005, minValue: 0.0, maxValue: 0.2, explanation: "Burial rate for ironbound P", sensitivityCalculation: true),
    ...
    func convertDimensional2Params(dimensional: [Parameter]) -> [Parameter] {
        ...
        nonDim["o2min"]!.addParameterValues(values: dim["O2Min"]! / X0)
        nonDim["o2max"]!.addParameterValues(values: dim["O2Max"]! / X0)
        var out = [Parameter]()
        for p in outParams {
    ...
    fileprivate func convertdvalues2pvalues(dv: [String: Double]) -> [String: Double] {
        ...
        pv["o2min"]! = dv["O2Min"]! / X0
        pv["o2max"]! = dv["O2Max"]! / X0
        return pv
    }
    ...
    func convertNonDimensional2Dimensional(dimensional: [Parameter], params : [Parameter]) -> [Parameter] {
        ...
        dim["O2Min"]!.addParameterValues(values: nonDim["o2min"]! * X0)
        dim["O2Max"]!.addParameterValues(values: nonDim["o2max"]! * X0)
    ...
    func getCoefficients(_ state: [Double]) -> [[Double]] {
        ...
        let alpha1 = pv["alphaPlus"]!
        let beta1 = pv["betaPlus"]!
        let alpha2 = alpha(alphaPlus: pv["alphaPlus"]!, alphaMinus: pv["alphaMinus"]!, o2min: pv["o2min"]!, o2max: pv["o2max"]!, o2: o2)
        let beta2 = alpha(alphaPlus: pv["betaPlus"]!, alphaMinus: pv["betaMinus"]!, o2min: pv["o2min"]!, o2max: pv["o2max"]!, o2: o2)
        let tanhm = -tanh(-pv["m"]!)
    ...
    private func alpha(alphaPlus: Double, alphaMinus: Double, o2min: Double, o2max: Double, o2: Double) -> Double {
        let omega = (o2 - o2min) / (o2max - o2min)
        return alphaPlus + (alphaMinus - alphaPlus) * (1.0 - omega * hstep(omega)) * hstep(1.0 - omega)
    }
    private func derivAlpha(alphaPlus: Double, alphaMinus: Double, o2min: Double, o2max: Double, o2: Double) -> Double {
        let omega = (o2 - o2min) / (o2max - o2min)
        return (alphaPlus - alphaMinus) * hstep(omega) * hstep(1.0 - omega)
    }
...
//    }
    ...
    fileprivate func jacobian(_ state: [Double], pv: [String: Double]) -> [[Double]] {
        ...
        let dalphado2 = derivAlpha(alphaPlus: pv["alphaPlus"]!, alphaMinus: pv["alphaMinus"]!, o2min: pv["o2min"]!, o2max: pv["o2max"]!, o2: o2)
        let dbetado2 = derivAlpha(alphaPlus: pv["betaPlus"]!, alphaMinus: pv["betaMinus"]!, o2min: pv["o2min"]!, o2max: pv["o2max"]!, o2: o2)
